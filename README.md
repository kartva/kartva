...
#### Fall 2025
- I will be interning at [Neuralink](https://neuralink.com/).

#### Summer 2025
- I am running the [SIGHORSE🦓](https://sig.horse/) mock journal for Purdue Hackers.
- **I am interning at [Modular](https://www.modular.com/)** working on the Mojo standard library, with Chris Lattner of LLVM fame. Nearly all of my work was open-source in the [Modular monorepo](https://github.com/modular/modular/). ~~I will not be at ETH Zurich for those wondering.~~
